...
>22 anos e natural de Nova Iguaçu, RJ. Apaixonado por tecnologia, programação e dados.
...
Atuei como Assistente Administrativo da Qualidade Terceirizado na Raízen Lubrificantes, onde fui responsável pelo suporte às rotinas do Sistema de Gestão da Qualidade (SLA), atuando no controle de envios de amostras para clientes e laboratórios externos, na gestão de materiais do laboratório e na organização de arquivos, garantindo eficiência, rastreabilidade e conformidade com os padrões estabelecidos pelo LQS.
...
>Atráves da faculdade e de cursos remotos, estou me aprimorando tecnicamente para entrar no mercado de trabalho.
